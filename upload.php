...
/*
İletişim:
Mail: info@scripthanesi.com | zulkuf.yalcin@scripthanesi.com
Link: https://www.scripthanesi.com/iletisim
*/
 ?>
<!DOCTYPE html>
<html>
...
$siteAdresi = 'http://hizliresim.scripthanesi.com';
            ...
            <label for="file-upload" id="file-drag">
                ...
                <div id="response" class="">
                    ...
                    <table cellpadding="5" cellspacing="5">
                        ...
                        <tr>
                            <td>
                                <a style="color:blue;text-decoration: none;font-weight:bold" target="_blank" href="<?php echo $siteAdresi.'/resim/'.$handle->file_dst_name.'' ?>"><?php echo $siteAdresi . '/resim/'.$handle->file_dst_name.'' ?></a>
                            </td>
                        </tr>
                    </table>
                </div>
